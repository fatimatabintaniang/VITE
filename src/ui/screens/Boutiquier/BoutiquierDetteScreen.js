  ...
  <div class="max-w-6xl mx-auto px-4 mt-20 sm:px-6 lg:px-8 py-8 ">
    ...
    ${dettes.length === 0 ? `
      <div class="text-center py-20">
        <img src="/assets/images/255854130_2e0d2f40-779c-4838-aeac-1b03ab9e39db.jpg" alt="Aucune dette" class="mx-auto w-52 h-52 opacity-70 mb-6" />
        <p class="text-gray-600 text-lg font-medium">Aucune demande de dettes disponible.</p>
      </div>
    ` : `
              ...
              <div class="space-y-3">
                <div>
                  ...
                  <p class="text-gray-500 flex items-center">
                    ...
                    ${d.client.utilisateur?.telephone || "Non renseigné"}
                  </p>
                </div>
